...
public class Lang {
	...
	public static void initialize() {
		...
		ITALIAN_WORDS[TEMPLE_UPGRADE_1] = "Santuario dell’Amore";
		ITALIAN_WORDS[TEMPLE_UPGRADE_1_JOKE] = "Un luogo per dare e ricevere";
		ITALIAN_WORDS[TEMPLE_UPGRADE_2] = "Offerte generose";
		ITALIAN_WORDS[TEMPLE_UPGRADE_2_JOKE] = "Mai è stato così facile guadagnarsi la vita";
		ITALIAN_WORDS[TEMPLE_UPGRADE_3] = "Visioni divine";
		ITALIAN_WORDS[TEMPLE_UPGRADE_3_JOKE] = "Niente più vino scadente";
		ITALIAN_WORDS[TEMPLE_UPGRADE_4] = "Chierichetto obbedienti";
		ITALIAN_WORDS[TEMPLE_UPGRADE_4_JOKE] = "Questi ragazzi fanno più sopportabili le lunghe e dure messe nel monastero";
		ITALIAN_WORDS[TEMPLE_UPGRADE_5] = "Peccatori pentiti";
		ITALIAN_WORDS[TEMPLE_UPGRADE_5_JOKE] = "Inginocchiati e guadagna il perdono";
		ITALIAN_WORDS[TEMPLE_UPGRADE_6] = "Anziano con vestito";
		ITALIAN_WORDS[TEMPLE_UPGRADE_6_JOKE] = "Io sono la voce di Dio sulla terra";
		ITALIAN_WORDS[TEMPLE_UPGRADE_7] = "Caccia alle streghe";
		ITALIAN_WORDS[TEMPLE_UPGRADE_7_JOKE] = "Queste signore hanno bisogno d’affetto, disperatamente";
		...
		ITALIAN_WORDS[SHIP_UPGRADE_2] = "Polena oscena";
		ITALIAN_WORDS[SHIP_UPGRADE_2_JOKE] = "L’equipaggio sembra essere animato";
		ITALIAN_WORDS[SHIP_UPGRADE_3] = "Scambio interculturale";
		ITALIAN_WORDS[SHIP_UPGRADE_3_JOKE] = "Godati il cocco delle Amazoni";
		ITALIAN_WORDS[SHIP_UPGRADE_4] = "Influenza dell’amore contagioso";
		ITALIAN_WORDS[SHIP_UPGRADE_4_JOKE] = "L’amore è nell’aria";
		ITALIAN_WORDS[SHIP_UPGRADE_5] = "Gli eletti";
		ITALIAN_WORDS[SHIP_UPGRADE_5_JOKE] = "Una razza per domarle tutte";
		ITALIAN_WORDS[SHIP_UPGRADE_6] = "Convertire infedeli";
		ITALIAN_WORDS[SHIP_UPGRADE_6_JOKE] = "Insegna loro come si deve amare";
		ITALIAN_WORDS[SHIP_UPGRADE_7] = "Frustate piacevoli";
		ITALIAN_WORDS[SHIP_UPGRADE_7_JOKE] = "Ora con lividi a forma di cuore";
		...
		ROMANIAN_WORDS[TEMPLE_UPGRADE_1] = "Sanctuarul dragostei";
		ROMANIAN_WORDS[TEMPLE_UPGRADE_1_JOKE] = "Un loc în care poți sa dai și să primești";
		ROMANIAN_WORDS[TEMPLE_UPGRADE_2] = "Milostenii generoase";
		ROMANIAN_WORDS[TEMPLE_UPGRADE_2_JOKE] = "Niciodată n-a fost așa de ușor să-ți câștigi viața";
		ROMANIAN_WORDS[TEMPLE_UPGRADE_3] = "Viziuni divine";
		ROMANIAN_WORDS[TEMPLE_UPGRADE_3_JOKE] = "Nu mai vin ieftin";
		ROMANIAN_WORDS[TEMPLE_UPGRADE_4] = "Băieți de altar ascultători";
		ROMANIAN_WORDS[TEMPLE_UPGRADE_4_JOKE] = "Băieții ăștia fac mai suportabile lungile si grele servicii religioase";
		ROMANIAN_WORDS[TEMPLE_UPGRADE_5] = "Păcătoșilor pocăițivă";
		ROMANIAN_WORDS[TEMPLE_UPGRADE_5_JOKE] = "Îngenuncheazăte și câștigăți iertarea";
		ROMANIAN_WORDS[TEMPLE_UPGRADE_6] = "Vârstnic cu rochie";
		ROMANIAN_WORDS[TEMPLE_UPGRADE_6_JOKE] = "Sunt vocea lui dumnezeu pe pamant";
		ROMANIAN_WORDS[TEMPLE_UPGRADE_7] = "Vânătoare de vrăjitoare";
		ROMANIAN_WORDS[TEMPLE_UPGRADE_7_JOKE] = "Damele acestea au nevoie de afecțiune cu disperare";
		...
		ROMANIAN_WORDS[SHIP_UPGRADE_2] = "Figură de galion obscenă";
		ROMANIAN_WORDS[SHIP_UPGRADE_2_JOKE] = "Oamenii de pe barcă par plini de chef";
		ROMANIAN_WORDS[SHIP_UPGRADE_3] = "Schimb intercultural";
		ROMANIAN_WORDS[SHIP_UPGRADE_3_JOKE] = "Bucurăte de nucile de cocos a le Amazoanelor";
		ROMANIAN_WORDS[SHIP_UPGRADE_4] = "Gripa dragostei";
		ROMANIAN_WORDS[SHIP_UPGRADE_4_JOKE] = "Dragostea e în aer";
		ROMANIAN_WORDS[SHIP_UPGRADE_5] = "Cei aleși";
		ROMANIAN_WORDS[SHIP_UPGRADE_5_JOKE] = "o rasă pentru a le domina pe toate";
		ROMANIAN_WORDS[SHIP_UPGRADE_6] = "A pocaii heretici";
		ROMANIAN_WORDS[SHIP_UPGRADE_6_JOKE] = "Învațăi să iubească cum trebuie";
		ROMANIAN_WORDS[SHIP_UPGRADE_7] = "Lovituri de bici plăcute";
		ROMANIAN_WORDS[SHIP_UPGRADE_7_JOKE] = "Acuma cu vânătăi cu formă de inimioară";
		...
		GERMAN_WORDS[TEMPLE_UPGRADE_1] = "Heilige stätte der liebe";
		GERMAN_WORDS[TEMPLE_UPGRADE_1_JOKE] = "Ein ort zum geben und nehmen";
		GERMAN_WORDS[TEMPLE_UPGRADE_2] = "Großzügiger almosengeber";
		GERMAN_WORDS[TEMPLE_UPGRADE_2_JOKE] = "Niemals war es so einfach sich ein leben zu verdienen";
		GERMAN_WORDS[TEMPLE_UPGRADE_3] = "Göttliche vision";
		GERMAN_WORDS[TEMPLE_UPGRADE_3_JOKE] = "Keinen billigen wein mehr";
		GERMAN_WORDS[TEMPLE_UPGRADE_4] = "Unterwürfige altar-jünger";
		GERMAN_WORDS[TEMPLE_UPGRADE_4_JOKE] = "Diese jungs machen die lange und harte messen in dem kloster erträglich";
		GERMAN_WORDS[TEMPLE_UPGRADE_5] = "Reumütige sünder";
		GERMAN_WORDS[TEMPLE_UPGRADE_5_JOKE] = "Geht auf die knie und erarbeitet euch eure vergebung";
		GERMAN_WORDS[TEMPLE_UPGRADE_6] = "Stammesältester in einem anzug";
		GERMAN_WORDS[TEMPLE_UPGRADE_6_JOKE] = "Ich bin die stimme Gottes auf der welt";
		GERMAN_WORDS[TEMPLE_UPGRADE_7] = "Hexenjäger";
		GERMAN_WORDS[TEMPLE_UPGRADE_7_JOKE] = "Diese verzweifelten damen brauchen zuneigung";
		...
		GERMAN_WORDS[SHIP_UPGRADE_2_JOKE] = "Die crew sieht motiviert aus";
		GERMAN_WORDS[SHIP_UPGRADE_3] = "Interkultureller austausch";
		GERMAN_WORDS[SHIP_UPGRADE_3_JOKE] = "Genieß die kokosnüsse aus dem Amazonas";
		GERMAN_WORDS[SHIP_UPGRADE_4] = "Ansteckendes liebes-fieber";
		GERMAN_WORDS[SHIP_UPGRADE_4_JOKE] = "Liebe ist in der luft";
		GERMAN_WORDS[SHIP_UPGRADE_5] = "Die auserwählten";
		GERMAN_WORDS[SHIP_UPGRADE_5_JOKE] = "Eine rasse, sie alle zu knechten";
		GERMAN_WORDS[SHIP_UPGRADE_6] = "Umgewandelte ungläubige";
		GERMAN_WORDS[SHIP_UPGRADE_6_JOKE] = "Bringt ihnen bei, wie man richtig liebt";
		GERMAN_WORDS[SHIP_UPGRADE_7] = "Vergnügliche peitschenschnur";
		GERMAN_WORDS[SHIP_UPGRADE_7_JOKE] = "Jetzt mit blauen flecken in herz-form";
		...
		RUSSIAN_WORDS[TEMPLE_UPGRADE_1] = "Святилище любви";
		RUSSIAN_WORDS[TEMPLE_UPGRADE_1_JOKE] = "Место, чтобы давать и получать";
		RUSSIAN_WORDS[TEMPLE_UPGRADE_2] = "Щедрое подаяние";
		RUSSIAN_WORDS[TEMPLE_UPGRADE_2_JOKE] = "Никогда не было так просто зарабатывать на жизнь";
		RUSSIAN_WORDS[TEMPLE_UPGRADE_3] = "Божественные видения";
		RUSSIAN_WORDS[TEMPLE_UPGRADE_3_JOKE] = "Никогда больше дешевое вино";
		RUSSIAN_WORDS[TEMPLE_UPGRADE_4] = "Алтарь мальчики";
		RUSSIAN_WORDS[TEMPLE_UPGRADE_4_JOKE] = "Эти мальчики делают терпимый эти длинный и нудный службы божие в монастыре";
		RUSSIAN_WORDS[TEMPLE_UPGRADE_5] = "Раскаявшийся грешник";
		RUSSIAN_WORDS[TEMPLE_UPGRADE_5_JOKE] = "Встаньте на колени и выиграы прощение";
		RUSSIAN_WORDS[TEMPLE_UPGRADE_6] = "Старец в платье";
		RUSSIAN_WORDS[TEMPLE_UPGRADE_6_JOKE] = "Я голос Бога на Земле";
		RUSSIAN_WORDS[TEMPLE_UPGRADE_7] = "Охота на ведьм";
		RUSSIAN_WORDS[TEMPLE_UPGRADE_7_JOKE] = "Эти дамы отчаянно нуждаются в любви";
		...
		RUSSIAN_WORDS[SHIP_UPGRADE_2] = "Извращенный маскарон";
		RUSSIAN_WORDS[SHIP_UPGRADE_2_JOKE] = "Экипаж выглядит веселым";
		RUSSIAN_WORDS[SHIP_UPGRADE_3] = "Межкультурный обмен";
		RUSSIAN_WORDS[SHIP_UPGRADE_3_JOKE] = "Наслаждайтесь кокосамы с Амазонак";
		RUSSIAN_WORDS[SHIP_UPGRADE_4] = "Инфекционный гриппа любовы";
		RUSSIAN_WORDS[SHIP_UPGRADE_4_JOKE] = "Любовь находится в воздухе";
		RUSSIAN_WORDS[SHIP_UPGRADE_5] = "Избранный";
		RUSSIAN_WORDS[SHIP_UPGRADE_5_JOKE] = "Одна раса, чтобы управлять ими всеми";
		RUSSIAN_WORDS[SHIP_UPGRADE_6] = "Новообращенный неверных";
		RUSSIAN_WORDS[SHIP_UPGRADE_6_JOKE] = "Учите их правильно любить";
		RUSSIAN_WORDS[SHIP_UPGRADE_7] = "Приятные ударами плетью";
		RUSSIAN_WORDS[SHIP_UPGRADE_7_JOKE] = "Сейчас в синяках форми сердца";
