...
public class StoreItem {
	...
	public float custom_alpha = 0.7f;
	...
	public StoreItem (Screen screen, int id) {
		
		storeParent = (Store)screen;
...
//		System.out.println("");
		...
		background.setX(TG.Display.WIDTH*((float)storeParent.POSITION+0.5f) -background.getWidth()/2);
		...
		label.setX(TG.Display.WIDTH*((float)storeParent.POSITION+0.5f) -label.getWidth()/2 +icon.getWidth()/2*icon.getScaleX() +5f);
		...
		background2.setX(TG.Display.WIDTH*((float)storeParent.POSITION+0.5f) -background2.getWidth()/2);
		...
		buy.setX(TG.Display.WIDTH*((float)storeParent.POSITION+0.5f) -buy.getWidth()/2);
		...
		info.setWrap(true);
		info.setWidth(300);
		info.setX(TG.Display.WIDTH*((float)storeParent.POSITION+0.5f) -info.getWidth()/2);
		info.setY(300);
	...
	float modified_x = (x - TG.Display.whiteSpaceX)*(1f/TG.Display.scale) +TG.Display.WIDTH*storeParent.POSITION;
