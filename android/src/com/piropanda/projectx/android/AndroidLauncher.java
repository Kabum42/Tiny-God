package com.piropanda.projectx.android;
...
import com.piropanda.projectx.GoogleInterface;
import com.piropanda.projectx.helpers.*;
...
public class AndroidLauncher extends AndroidApplication implements GoogleInterface, ConnectionCallbacks, OnConnectionFailedListener {
	...
	private ProjectX game = new ProjectX(this);
